...
PLUGIN_DIR="$SUBNAUTICA_PATH/BepInEx/plugins/DontFearTheReaper"
DLL_PATH="DontFearTheReaper/bin/Release/net472/DontFearTheReaper.dll"
LOCALIZATION_PATH="DontFearTheReaper/Localizations.xml"
ASSETS_PATH="DontFearTheReaper/Assets"
if [ -f "$DLL_PATH" ]; then
    mkdir -p "$PLUGIN_DIR"
